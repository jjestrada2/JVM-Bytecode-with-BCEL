...
public class GenerateClass {
    ...
    public static void main(String[] args) {
        ...
        MethodGen methodGen=new MethodGen(Constants.ACC_PUBLIC|Constants.ACC_STATIC, Type.VOID, new Type[]{new ArrayType(Type.STRING, 1)}, new String[]{"args"}, "main", "out.synthetic.SyntheticClass", instructionList, constantPoolGen);
